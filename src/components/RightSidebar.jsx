    ...
    return (
        <aside className="tools">
            <div className="tools-intro">
                ...
                <h2 className="tools-intro-title">Inspector, Notes &amp; AI</h2>
                <p className="tools-intro-copy">
                    Keep metadata, citations, section links, paper notes, draft writing, and AI
                    behaviour connected to the active paper without leaving the reading view.
                </p>
            </div>
            ...
            <div className="tools-groups">
                ...
                <section className="tools-group">
                    <div className="tools-group-label">Writing Surface</div>
                    <CollapsibleCard
